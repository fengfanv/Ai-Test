...
class MultiLayerNetExtend:
    ...
    我自己改造的，删减版，仅具有Batch Normalization的功能
    ...
    def __init__(self, input_size, hidden_size_list, output_size, activation='relu', weight_init_std='relu', use_batchnorm=False):
        ...
        for idx in range(1, self.hidden_layer_num+1):
            ...
            if self.use_batchnorm:
                self.params['gamma' + str(idx)] = np.ones(hidden_size_list[idx-1])#数组下标是从0开始的，但这个循环是从1开始的，所以要想取数组里第一个数组，需要 减1 。这里的 减1 ，和权重初始值时的 减1 不一样，权重初始值 减1 是取前一层神经元的数量，
